export const MAX_PAYLOAD_BYTES = 50 * 1024 * 1024; // cap incoming frame size (50 MB — supports ~35 MB base64 from 25 MB attachments)
export const MAX_BUFFERED_BYTES = 60 * 1024 * 1024; // per-connection send buffer limit
